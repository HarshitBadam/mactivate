...
/// digests) but says nothing about real hardware. Signal shapes follow the
/// expected signatures in the gesture-hypotheses doc so downstream code sees
/// plausible structure, not white noise.
public final class MockSensorSource: SensorSource {
    ...
    public func generate() -> [SensorSample] {
        ...
        return samples.sortedDeterministically()
    }
}
