...
/// measured by `tools/analysis/score_rule.py` (which applies the identical rule on
/// top of `tools/analysis/analyze_imu.py`'s pipeline — the project's analysis ground
...
final class TapClassifierCaptureFixtureTests: XCTestCase {
    ...
    /// Measured 2026-07-24 (tools/analysis/score_rule.py, threshold 0.04 g, no skip,
    ...
    private static var capturesRoot: URL {
        ...
        while directory.path != "/" {
            if FileManager.default.fileExists(
                ...
                return directory.appendingPathComponent("captures")
            }
